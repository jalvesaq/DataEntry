...
VarListDlg <- function(...)
{
    ...
    addHandlerChanged(eBt, function(...) AttrDlg(FALSE))
    addHandlerChanged(aBt, function(...) AttrDlg(TRUE))
    addHandlerChanged(dBt, DeleteVariable)
    addHandlerClicked(DEenv$vlist, ShowAttributes)
    addHandlerChanged(upBt, function(...) MoveUpDown(TRUE))
    addHandlerChanged(dwBt, function(...) MoveUpDown(FALSE))
    addHandlerChanged(clsBt, function(...) dispose(DEenv$varw))
